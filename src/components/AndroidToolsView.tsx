...
export default function AndroidToolsView({ tools }: { tools: Tool[] }) {
  ...
  const categoryColors: Record<ToolCategory, { bg: string, text: string, icon: string, border: string }> = {
    ...
    Security: { bg: 'bg-indigo-50 dark:bg-indigo-900/20', text: 'text-indigo-600 dark:text-indigo-400', icon: 'text-indigo-500', border: 'border-indigo-100 dark:border-indigo-900/30' },
