...
import { Image as ImageIcon, Loader2, ArrowRight, X, FileUp } from 'lucide-react'
...
return (
  <NativeToolLayout title="PDF to Image" description="Convert document pages into high-quality images." actions={pdfData && !downloadUrl && <ActionButton />}>
