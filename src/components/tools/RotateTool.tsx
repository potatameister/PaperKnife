...
import { RotateCw, RefreshCcw, Loader2, X, FileUp } from 'lucide-react'
...
export default function RotateTool() {
  ...
  const savePDF = async () => {
    ...
    try {
      ...
      addActivity({ name: `${customFileName}.pdf`, tool: 'Rotate', size: blob.size, resultUrl: url, buffer: pdfBytes })
  ...
  return (
    <NativeToolLayout title="Rotate PDF" description="Tap individual pages to rotate 90 degrees." actions={pdfData && !downloadUrl && <ActionButton />}>
